...
class BackendTradeResult {
  ...
  factory BackendTradeResult.fromJson(Map<String, dynamic> json) =>
      BackendTradeResult(
...
class BackendLeaderboardEntry {
  ...
  factory BackendLeaderboardEntry.fromJson(Map<String, dynamic> json) =>
      BackendLeaderboardEntry(
        userId: json['user_id'],
        username: json['username'],
        xp: json['xp'],
...
class AstraTradeBackendClient {
  ...
  AstraTradeBackendClient({http.Client? httpClient})
  ...
  Future<BackendTradeResult> placeTrade({
    required int userId,
