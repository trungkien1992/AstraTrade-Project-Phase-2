...
final userNFTCollectionProvider = FutureProvider.family<NFTCollection, int>((ref, userId) async {
...
final eligibleAchievementsProvider = FutureProvider<List<EligibleAchievement>>((ref) async {
  final nftService = ref.read(nftServiceProvider);
  return await nftService.getEligibleAchievements();
});

/// Provider for NFT marketplace listings
final nftMarketplaceProvider = FutureProvider.family<List<NFTMarketplaceItem>, Map<String, dynamic>>((ref, filters) async {
  final nftService = ref.read(nftServiceProvider);
...
final globalNFTStatsProvider = FutureProvider<Map<String, dynamic>>((ref) async {
  final nftService = ref.read(nftServiceProvider);
