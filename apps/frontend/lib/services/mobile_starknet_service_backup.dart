...
class MobileStarknetService {
  ...
  static const String _accountClassHash = '0x061dac032f228abef9c6626f995015233097ae253a7f72d68552db02f2971b8f';
  ...
  Future<void> initialize({bool useMainnet = false}) async {
    try {
      ...
      debugPrint('✅ Mobile Starknet service initialized on ${useMainnet ? 'mainnet' : 'sepolia'}');
    } catch (e) {
  ...
  Future<MobileWalletData> createWallet({
    ...
    try {
      ...
      if (privateKeyBigInt >= _starknetFieldPrime || privateKeyBigInt == BigInt.zero) {
        throw MobileStarknetException('Generated private key outside valid range');
      }
      
      final privateKeyHex = '0x${privateKeyBigInt.toRadixString(16).padLeft(64, '0')}';
  ...
  Future<String> signTransaction({
    ...
    try {
      ...
      return result.when(
        ...
        error: (error) => throw MobileStarknetException('Transaction failed: $error'),
      );
    } catch (e) {
  ...
  Future<BigInt> getBalance([String? tokenAddress]) async {
    try {
      ...
      final token = tokenAddress ?? '0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7';
  ...
  void _ensureAccountLoaded() {
    ...
    if (_currentAccount == null) {
      throw MobileStarknetException('No account loaded. Create or import a wallet first.');
    }
  }
}
