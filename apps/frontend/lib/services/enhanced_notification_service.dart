...
class EnhancedNotificationService {
  ...
  static const String _channelDescription =
      'Notifications for cosmic trading activities';
    ...
    try {
      ...
      if (currentTime - lastProcessTime > 300000) {
        ...
        await prefs.setDouble(
          'stellar_shards',
          currentSS + stellarShardsGenerated,
        );
  ...
  static Future<void> _checkStreakReminders() async {
    ...
    if (currentTime - lastLoginTime > 72000000) {
      // 20 hours
  ...
  static Future<void> _showQuantumAnomalyEndingNotification(
