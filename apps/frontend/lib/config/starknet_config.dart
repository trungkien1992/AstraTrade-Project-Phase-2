...
class StarknetConfig {
  ...
  static String get chainId =>
      useMainnet ? '0x534e5f4d41494e' : '0x534e5f5345504f4c4941';

  /// Block explorer URL for the current network
  static String get blockExplorerUrl =>
      useMainnet ? 'https://starkscan.co' : 'https://sepolia.starkscan.co';
  ...
  static Map<String, String> get tokenContracts => useMainnet
      ...
      : {
          'ETH':
              '0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7',
          'USDC':
              '0x053c91253bc9682c04929ca02ed00b3e423f6710d2ee7e0d5ebb06f3ecf368a8', // Testnet USDC
          'USDT':
              '0x068f5c6a61780768455de69077e07e89787839bf8166decfbf92b645209c0fb8', // Testnet USDT
          'STRK':
              '0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d', // Testnet STRK
        };
}

final environmentStarknetServiceProvider = Provider((ref) {
  final useMainnet = const bool.fromEnvironment(
    'USE_MAINNET',
    defaultValue: false,
  );
...
final networkModeProvider = StateProvider<bool>(
  (ref) => StarknetConfig.useMainnet,
);
