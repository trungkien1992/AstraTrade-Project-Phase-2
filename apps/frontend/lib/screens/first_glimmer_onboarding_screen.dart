...
class FirstGlimmerOnboardingScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<FirstGlimmerOnboardingScreen> createState() => _FirstGlimmerOnboardingScreenState();
}

class _FirstGlimmerOnboardingScreenState extends ConsumerState<FirstGlimmerOnboardingScreen>
        ...
        return Container(
          decoration: BoxDecoration(
            gradient: RadialGradient(
              ...
              colors: [
                Colors.purple.withOpacity(0.1 + _cosmicGlowController.value * 0.2),
                Colors.blue.withOpacity(0.05 + _cosmicGlowController.value * 0.1),
                Colors.black,
              ],
  ...
  Widget _buildCosmicAwakeningStep() {
    return Column(
      ...
      children: [
        ...
        ).animate().fadeIn(delay: 1500.ms).slideY(
          begin: 0.5,
          end: 0,
          duration: 800.ms,
        ),
