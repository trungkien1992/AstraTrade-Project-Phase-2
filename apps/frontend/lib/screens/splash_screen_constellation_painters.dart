...
class MilkyWayPainter extends CustomPainter {
  ...
  MilkyWayPainter({required this.animationValue, required this.glowIntensity});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (final star in _stars) {
      ...
      final twinkle =
          star.brightness *
          (0.3 +
              0.7 * math.sin(animationValue * 3 * math.pi + star.twinklePhase));
