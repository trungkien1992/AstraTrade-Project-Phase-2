...
class StreakTrackerScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Track screen view
    AnalyticsService.trackScreenView('streak_tracker_screen', properties: {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () async {
              await AnalyticsService.trackUserAction('analytics_dashboard_opened', properties: {
                'source': 'streak_tracker_screen',
              });
                ...
                child: Column(
                  children: [
                    ...
                    if (progress.currentStreak > 0) ...[
                      ...
                      Text(
                        progress.isStreakActive ? 'Keep it going!' : 'Trade today to continue!',
                        style: TextStyle(
                          fontSize: 14,
                          color: progress.isStreakActive ? Colors.green : Colors.orange,
              ...
              child: trades.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return ListTile(
                          leading: Icon(
                            trade.direction == 'BUY' ? Icons.trending_up : Icons.trending_down,
                            color: trade.direction == 'BUY' ? Colors.green : Colors.red,
                          ),
                          ...
                          trailing: trade.isCompleted
                              ? Text(
                                  ...
                                  style: TextStyle(
                                    color: trade.profitLossPercentage > 0 ? Colors.green : Colors.red,
                                    fontWeight: FontWeight.bold,
                                  ),
                                )
                              : const Text('Pending'),
