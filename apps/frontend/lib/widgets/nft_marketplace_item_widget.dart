...
/// Widget to display an NFT marketplace item
class NFTMarketplaceItemWidget extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Icon(
                  _getAchievementIcon(item.achievementType),
                  size: 40,
                  color: Colors.white,
                ),
              ),
              ...
              // NFT name
              Text(
                item.metadata['name'] ?? 'Genesis NFT',
              ...
              Row(
                ...
                children: [
                  Text(
                    '${item.price.toStringAsFixed(0)} ${item.currency.toUpperCase()}',
                    style: const TextStyle(
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
                    ),
