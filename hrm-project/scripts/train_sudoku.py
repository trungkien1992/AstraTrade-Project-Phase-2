"""
Training script for HRM on Sudoku-Extreme benchmark
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train HRM on Sudoku-Extreme")
    ...
    parser.add_argument("--difficulty_min", type=int, default=15, help="Minimum difficulty (backtracks)")
    parser.add_argument("--difficulty_max", type=int, default=40, help="Maximum difficulty (backtracks)")
    
    # Output configuration
    parser.add_argument("--output_dir", type=str, default="./outputs/sudoku", help="Output directory")
    parser.add_argument("--cache_dir", type=str, default="./cache", help="Cache directory")
    parser.add_argument("--use_wandb", action="store_true", help="Use Weights & Biases logging")
    parser.add_argument("--project_name", type=str, default="hrm-sudoku", help="W&B project name")
...
def main():
    ...
    if args.use_wandb:
        wandb.init(
            ...
            config=vars(args),
            name=f"hrm-sudoku-N{args.N}-T{args.T}-{'act' if args.use_act else 'ds'}"
        )
    ...
    model_config = HRMConfig(
        ...
        vocab_size=12,  # Sudoku vocab size
        N=args.N,
        T=args.T,
        mmax=args.max_segments,
        use_stablemax=True,  # Use stablemax for small-sample learning
    )
    ...
    # Create datasets
    print("Creating Sudoku-Extreme datasets...")
